...
* **Strict Prohibitions:**
  ...
  - **NO IRREVERSIBLE MUTATIONS:** Every executed entry has an explicit compensating reversal pathway via [`ReversalEngine`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/action/reversal.py).

---

## 2. Tools & Capabilities

Implemented in [`ActionTools`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/action/tools.py):
...
* Unit Tests: [`tests/unit/test_action_agent_and_reversal.py`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/tests/unit/test_action_agent_and_reversal.py).
* Integration Tests: [`tests/integration/test_verification_action_reversal_flow.py`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/tests/integration/test_verification_action_reversal_flow.py).

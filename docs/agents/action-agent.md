...
* **Strict Prohibitions:**
  ...
  - **NO IRREVERSIBLE MUTATIONS:** Every executed entry has an explicit compensating reversal pathway via [`ReversalEngine`](../../backend/app/action/reversal.py).

---

## 2. Tools & Capabilities

Implemented in [`ActionTools`](../../backend/app/action/tools.py):
...
* Unit Tests: [`tests/unit/test_action_agent_and_reversal.py`](../../backend/tests/unit/test_action_agent_and_reversal.py).

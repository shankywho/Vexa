...
* **Deterministic Tool Boundaries:** The agent performs **zero mental arithmetic**. It executes calculations through typed tools in [`FinancialAnalystTools`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-8/backend/app/analyst/tools.py):
...
Defined in [`app/analyst/types.py`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-8/backend/app/analyst/types.py):
...
* Integration Tests: [`tests/integration/test_analyst_and_benchmarks.py`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-8/backend/tests/integration/test_analyst_and_benchmarks.py).

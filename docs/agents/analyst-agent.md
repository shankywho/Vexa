...
* **Deterministic Tool Boundaries:** The agent performs **zero mental arithmetic**. It executes calculations through typed tools in [`FinancialAnalystTools`](../../backend/app/analyst/tools.py):
...
Defined in [`app/analyst/types.py`](../../backend/app/analyst/types.py):
...
* Integration Tests: [`tests/integration/test_analyst_and_benchmarks.py`](../../backend/tests/integration/test_analyst_and_benchmarks.py).

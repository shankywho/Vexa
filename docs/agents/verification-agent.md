...
* **Inputs:** [`VerificationRequest`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/verification/types.py#L15) containing the raw finding, bounded dossier, and active `ClosePolicy`.
* **Outputs:** [`VerificationResult`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/verification/types.py#L28).
...
* Unit Tests: [`tests/unit/test_verification_agent.py`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/tests/unit/test_verification_agent.py).

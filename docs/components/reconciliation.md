...
Located at [`backend/app/reconciliation/`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/reconciliation/):
...
* **Logic:** Evaluates unit prices, quantities, item descriptions, and totals. Supports multi-currency conversion via [`FxService`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/services/fx_service.py).
* **Outputs:**
...
The reconciliation engine outputs a [`ReconciliationRunSummary`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/reconciliation/schemas.py#L88):

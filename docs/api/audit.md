...
Endpoints for retrieving immutable SOX audit events and internal control verification trails. Router: [`backend/app/api/routes/audit.py`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/api/routes/audit.py).
...
* **Response:** Array of [`AuditEventRead`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/domain/schemas.py).
* **Example Item:**
  ```json
  {

...
Endpoints for initiating, monitoring, and streaming month-end close runs. Router: [`backend/app/api/routes/close_runs.py`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/api/routes/close_runs.py).
...
* **Request:**
  ...
  ```
* **Response:** [`CloseRunRead`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/domain/schemas.py).

...
Endpoints for managing demonstration safety, toggling between LIVE and REPLAY execution, and streaming pre-recorded golden traces. Router: [`backend/app/api/routes/demo.py`](../../backend/app/api/routes/demo.py).
...
* **Response:** [`DemoModeRead`](../../backend/app/domain/schemas.py).

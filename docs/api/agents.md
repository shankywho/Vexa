...
Endpoints for inspecting autonomous agent runs and granular execution step telemetry. Router: [`backend/app/api/routes/agent_runs.py`](../../backend/app/api/routes/agent_runs.py).
...
* **Response:** [`AgentRunRead`](../../backend/app/domain/schemas.py).

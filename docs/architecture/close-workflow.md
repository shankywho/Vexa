...
A `CloseRun` transitions through 12 formal states governed by [`CloseWorkflowStateMachine`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/close_workflow/state_machine.py).
...
Vexa defines 10 discrete close tasks. The [`TaskDependencyResolver`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/close_workflow/dependencies.py) constructs and verifies a Directed Acyclic Graph (DAG) enforcing deterministic topological ordering:
...
The [`CloseWorkflowController`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/close_workflow/controller.py) executes the close workflow through structured phases:
...
Before advancing to `READY_TO_CLOSE`, [`CloseReadinessEvaluator`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/close_workflow/readiness.py) inspects company ledger state:
...
Once marked `READY_TO_CLOSE` or `CLOSED`, the system compiles an immutable **Close Package** ([`ClosePackageRead`](file:///Users/shankar/.ao/data/worktrees/vexa/vexa-7/backend/app/domain/schemas.py)):
